...
function buildWeeklyForecast() {
  weeklyForecastData.forEach(function(forecast) {
    ...
    <div class='weekly-forecast'>
      <div class='row'>
        <span class='box'><span class='weekday-title'>${date.getDay()}</span></span><span class='box'><img class='img-med' src='./styles/svg/${forecast["icon"]}.svg' alt='${forecast["summary"]}'/></span class='box'><span class='box'>${humidity}%<img class='img-small' src="./styles/drop.svg" alt="Humidity"></span><span class='box'>${lowTemp}${temperatureScale} <img class='img-small' src="./styles/arrow-pointing-down.svg" alt="Low Temp"></span><span class='box'>${highTemp}${temperatureScale} <img class='img-small' src="./styles/arrow-up.svg" alt="High Temp"></span>
      </div>
      `);
  });
}
